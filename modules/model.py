...
# This is tiny-yolo, maybe i will try to add some residual connection later
class YOLO(torch.nn.Module):
    def __init__(self, nc=64, S=13, BOX=5, CLS=2):
    ...
    #output a grid that has shape (batch_size, S, S, BOX, 4+1+1), i will apply nms later
